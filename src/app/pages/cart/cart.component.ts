                      ...
                      <div class="flex items-start justify-between">
                        <div class="flex-1">
                          <h3 class="text-lg font-medium text-gray-900 mb-1">
                            <a [routerLink]="['/product', item.product.id]" class="hover:text-flipkart-blue">
                              {{ item.product.title }}
                            </a>
                          </h3>
                          ...
                          <div class="flex items-center mb-2">
                            <div class="flex items-center">
                              @for (star of [1,2,3,4,5]; track star) {
                                <svg 
                                  class="w-4 h-4"
                                  [class.text-flipkart-yellow]="star <= item.product.rating"
                                  [class.text-gray-300]="star > item.product.rating"
                                  fill="currentColor" 
                                  viewBox="0 0 20 20"
                                >
                            ...
                            <span class="text-sm text-gray-500 ml-1">({{ item.product.reviewCount }})</span>
                          </div>
                          ...
                          @if (item.product.freeDelivery) {
                            <div class="flex items-center text-sm text-flipkart-green font-medium mb-4">
                      ...
                      <div class="flex items-center justify-between mt-4">
                        <div class="flex items-center space-x-3">
                          ...
                          <div class="flex items-center border border-gray-300 rounded">
                            ...
                            <span class="px-4 py-1 border-x border-gray-300 bg-gray-50">{{ item.quantity }}</span>
                            <button
                              (click)="updateQuantity(item.product.id, item.quantity + 1)"
            ...
            <div class="lg:col-span-1">
              <div class="bg-white rounded-lg shadow-sm border p-6 sticky top-6">
                ...
                <div class="space-y-3">
                  ...
                  <a routerLink="/" class="btn-outline w-full py-3 text-center block">
                    Continue Shopping
                  </a>
                </div>
              </div>
