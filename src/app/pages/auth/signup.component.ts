      ...
      <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-600">
            ...
            <a routerLink="/login" class="font-medium text-flipkart-blue hover:text-flipkart-blue/80">
              Sign in here
            </a>
          </p>
        </div>
              ...
              <div>
                ...
                <div class="mt-1 relative">
                  <input
                    ...
                    class="input w-full pr-10"
                    [class.border-red-500]="(signupForm.get('confirmPassword')?.invalid || signupForm.errors?.['passwordMismatch']) && signupForm.get('confirmPassword')?.touched"
                ...
                @if ((signupForm.get('confirmPassword')?.invalid || signupForm.errors?.['passwordMismatch']) && signupForm.get('confirmPassword')?.touched) {
                  <p class="mt-1 text-sm text-red-600">
              ...
              <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                  <label for="terms" class="text-gray-600">
                    I agree to the
                    <a href="#" class="text-flipkart-blue hover:text-flipkart-blue/80">Terms and Conditions</a>
                    and
                    <a href="#" class="text-flipkart-blue hover:text-flipkart-blue/80">Privacy Policy</a>
                  </label>
