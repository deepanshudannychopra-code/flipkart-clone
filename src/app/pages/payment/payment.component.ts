                ...
                <form [formGroup]="cardForm" class="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      class="mt-1 input w-full"
                      [class.border-red-500]="
                        cardForm.get('cardHolder')?.invalid &&
                ...
                <form [formGroup]="upiForm">
                  <div>
                    ...
                    <input
                      ...
                      class="mt-1 input w-full"
                      [class.border-red-500]="
                        upiForm.get('upiId')?.invalid &&
                        upiForm.get('upiId')?.touched
                      "
                    />
                    @if (
                      upiForm.get("upiId")?.invalid &&
...
export class PaymentComponent implements OnInit {
  ...
  constructor() {
    ...
    this.upiForm = this.fb.group({
      upiId: [
        ...
        [
          Validators.required,
          Validators.pattern(/^[\w\.\-_]{3,}@[a-zA-Z]{3,}$/),
        ],
      ],
    });
  }
  ...
  processPayment() {
    ...
    setTimeout(() => {
      ...
      alert(
        "Payment successful! Your order has been placed. Transaction ID: " +
