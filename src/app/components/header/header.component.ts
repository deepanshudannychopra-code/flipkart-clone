        ...
        <div class="flex items-center justify-between py-3">
          ...
          <div class="flex items-center">
            <a routerLink="/" class="flex items-center">
              <div class="text-2xl font-bold text-flipkart-blue mr-8">
                <span class="bg-flipkart-blue text-white px-2 py-1 rounded italic">F</span>lipkart
                <div class="text-xs text-flipkart-yellow font-normal italic">Explore <span class="text-flipkart-blue">Plus</span></div>
              </div>
            </a>
          </div>
          ...
          <div class="flex-1 max-w-2xl mx-8">
            <div class="relative">
              ...
              >
                <svg class="w-5 h-5 text-flipkart-blue" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div class="flex items-center space-x-6">
            <!-- Login -->
            <button class="flex items-center space-x-1 text-flipkart-blue font-medium hover:text-flipkart-blue/80">
            ...
            <!-- Wishlist -->
            <a routerLink="/wishlist" class="flex items-center space-x-1 text-gray-700 hover:text-flipkart-blue relative">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd"/>
              </svg>
              <span>Wishlist</span>
              @if (wishlistCount() > 0) {
                <span class="absolute -top-2 -right-2 bg-flipkart-red text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                  {{ wishlistCount() }}
                </span>
              }
            </a>
            ...
            <!-- Cart -->
            <a routerLink="/cart" class="flex items-center space-x-1 text-gray-700 hover:text-flipkart-blue relative">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              ...
              @if (showMoreMenu) {
                <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg border z-50">
                  <div class="py-1">
                    ...
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Gift Cards</a>
